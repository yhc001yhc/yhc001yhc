...
# 3.创建开机后要运行的脚本
init = "wget https://codeload.github.com/yhc001yhc/yhc001yhc/zip/refs/heads/main && sudo apt-get install unzip && unzip main && cd yhc001yhc-main && chmod +x hacash_miner_pool_worker_2021_11_01_01 && ./hacash_miner_pool_worker_2021_11_01_01"
